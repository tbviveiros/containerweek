Vagrant.configure("2") do |config|
  config.vm.define "vm1" do |vm1|
    ...
    vm1.vm.provider :virtualbox do |vm1|
      ...
      vm1.customize ["modifyvm", :id, "--name", "vm1"]
    end
  end
  ...
  config.vm.define "vm2" do |vm2|
    ...
    vm2.vm.provider :virtualbox do |vm2|
      vm2.customize ["modifyvm", :id, "--natdnshostresolver1", "on"]
      vm2.customize ["modifyvm", :id, "--memory", 1024]
      vm2.customize ["modifyvm", :id, "--name", "vm2"]
    end
  end
  ...
  config.vm.define "vm3" do |vm3|
    vm3.vm.box = "centos/7"
    vm3.vm.hostname = 'vm3'
    vm3.vm.box_url = "centos/7"

    vm3.vm.network :private_network, ip: "192.168.56.103"

    vm3.vm.provider :virtualbox do |vm3|
      vm3.customize ["modifyvm", :id, "--natdnshostresolver1", "on"]
      vm3.customize ["modifyvm", :id, "--memory", 1024]
      vm3.customize ["modifyvm", :id, "--name", "vm3"]
    end
  end
